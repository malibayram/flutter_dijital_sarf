define(['dart_sdk', 'packages/collection/src/utils'], function(dart_sdk, utils) {
  ...
  src__algorithms.binarySearch = function binarySearch(T, sortedList, value, opts) {
  ...
  src__algorithms.lowerBound = function lowerBound(T, sortedList, value, opts) {
    let compare = opts && 'compare' in opts ? opts.compare : null;
    compare == null ? compare = src__utils.defaultCompare(T) : null;
    let min = 0;
    let max = sortedList[$length];
  ...
  src__algorithms.shuffle = function shuffle(list, start, end) {
  ...
  src__algorithms.reverse = function reverse(list, start, end) {
    if (start === void 0) start = 0;
    if (end === void 0) end = null;
    if (end == null) end = list[$length];
    src__algorithms._reverse(list, start, end);
  };
  src__algorithms._reverse = function _reverse(list, start, end) {
  ...
  src__algorithms.insertionSort = function insertionSort(T, list, opts) {
    let compare = opts && 'compare' in opts ? opts.compare : null;
  ...
  src__algorithms.mergeSort = function mergeSort(T, list, opts) {
    let start = opts && 'start' in opts ? opts.start : 0;
    let end = opts && 'end' in opts ? opts.end : null;
    let compare = opts && 'compare' in opts ? opts.compare : null;
    end == null ? end = list[$length] : null;
  ...
  src__algorithms._movingInsertionSort = function _movingInsertionSort(T, list, compare, start, end, target, targetOffset) {
    let length = dart.notNull(end) - dart.notNull(start);
    if (length === 0) return;
  ...
  src__algorithms._mergeSort = function _mergeSort(T, list, compare, start, end, target, targetOffset) {
    let length = dart.notNull(end) - dart.notNull(start);
    if (length < dart.notNull(src__algorithms._MERGE_SORT_LIMIT)) {
  ...
  src__algorithms._merge = function _merge(T, compare, firstList, firstStart, firstEnd, secondList, secondStart, secondEnd, target, targetOffset) {
