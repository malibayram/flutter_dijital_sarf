define(['dart_sdk'], function(dart_sdk) {
  ...
  src__comparators.equalsIgnoreAsciiCase = function equalsIgnoreAsciiCase(a, b) {
  ...
  src__comparators.hashIgnoreAsciiCase = function hashIgnoreAsciiCase(string) {
    let hash = 0;
  ...
  src__comparators.compareAsciiUpperCase = function compareAsciiUpperCase(a, b) {
    let defaultResult = 0;
    for (let i = 0; i < a.length; i = i + 1) {
  ...
  src__comparators.compareAsciiLowerCase = function compareAsciiLowerCase(a, b) {
    let defaultResult = 0;
    for (let i = 0; i < a.length; i = i + 1) {
      if (i >= b.length) return 1;
      let aChar = a[$codeUnitAt](i);
  ...
  src__comparators.compareNatural = function compareNatural(a, b) {
    for (let i = 0; i < a.length; i = i + 1) {
      if (i >= b.length) return 1;
      let aChar = a[$codeUnitAt](i);
      let bChar = b[$codeUnitAt](i);
  ...
  src__comparators.compareAsciiLowerCaseNatural = function compareAsciiLowerCaseNatural(a, b) {
    let defaultResult = 0;
    for (let i = 0; i < a.length; i = i + 1) {
      if (i >= b.length) return 1;
      let aChar = a[$codeUnitAt](i);
  ...
  src__comparators.compareAsciiUpperCaseNatural = function compareAsciiUpperCaseNatural(a, b) {
    let defaultResult = 0;
    for (let i = 0; i < a.length; i = i + 1) {
      if (i >= b.length) return 1;
      let aChar = a[$codeUnitAt](i);
  ...
  src__comparators._compareNaturally = function _compareNaturally(a, b, index, aChar, bChar) {
  ...
  src__comparators._compareNumerically = function _compareNumerically(a, b, aChar, bChar, index) {
  ...
  src__comparators._compareDigitCount = function _compareDigitCount(a, b, i, j) {
  ...
  src__comparators._isDigit = function _isDigit(charCode) {
    return (dart.notNull(charCode) ^ dart.notNull(src__comparators._zero)) >>> 0 <= 9;
  };
  src__comparators._isNonZeroNumberSuffix = function _isNonZeroNumberSuffix(string, index) {
