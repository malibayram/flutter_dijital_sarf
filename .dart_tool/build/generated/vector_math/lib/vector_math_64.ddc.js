define(['dart_sdk', 'packages/vector_math/hash'], function(dart_sdk, hash) {
  ...
  (vector_math_64.Aabb2.fromBuffer = function(buffer, offset) {
    ...
    this[_max] = new vector_math_64.Vector2.fromBuffer(buffer, dart.notNull(offset) + dart.notNull(typed_data.Float64List.bytesPerElement) * 2);
    ;
  }).prototype = vector_math_64.Aabb2.prototype;
  ...
  (vector_math_64.Aabb3.fromBuffer = function(buffer, offset) {
    ...
    this[_max] = new vector_math_64.Vector3.fromBuffer(buffer, dart.notNull(offset) + dart.notNull(typed_data.Float64List.bytesPerElement) * 3);
    ;
  }).prototype = vector_math_64.Aabb3.prototype;
  ...
  vector_math_64.Quaternion = class Quaternion extends core.Object {
    ...
    setRandom(rn) {
      ...
      let r2 = math.sqrt(x0);
      let t1 = dart.notNull(math.pi) * 2.0 * dart.notNull(rn.nextDouble());
      let t2 = dart.notNull(math.pi) * 2.0 * dart.notNull(rn.nextDouble());
      let c1 = math.cos(t1);
      let s1 = math.sin(t1);
      let c2 = math.cos(t2);
      let s2 = math.sin(t2);
  ...
  vector_math_64.Ray = class Ray extends core.Object {
    ...
    intersectsWithAabb3(other) {
      ...
      let tNear = -dart.notNull(core.double.maxFinite);
      ...
      for (let i = 0; i < 3; i = i + 1) {
        if (this[_direction]._get(i) === 0.0) {
          ...
          if (t2 < dart.notNull(tFar)) {
            tFar = t2;
          }
          if (tNear > dart.notNull(tFar) || dart.notNull(tFar) < 0) {
            return null;
          }
        }
      }
  ...
  vector_math_64.SimplexNoise = class SimplexNoise extends core.Object {
    ...
    noise3D(xin, yin, zin) {
      ...
      let n2 = null;
      let n3 = null;
      let s = (dart.notNull(xin) + dart.notNull(yin) + dart.notNull(zin)) * dart.notNull(vector_math_64.SimplexNoise._F3);
      let i = (dart.notNull(xin) + s)[$floor]();
      let j = (dart.notNull(yin) + s)[$floor]();
      let k = (dart.notNull(zin) + s)[$floor]();
      let t = (i + j + k) * dart.notNull(vector_math_64.SimplexNoise._G3);
      let X0 = i - t;
      let Y0 = j - t;
      let Z0 = k - t;
      let x0 = dart.notNull(xin) - X0;
      ...
      let x1 = x0 - dart.notNull(i1) + dart.notNull(vector_math_64.SimplexNoise._G3);
      let y1 = y0 - dart.notNull(j1) + dart.notNull(vector_math_64.SimplexNoise._G3);
      let z1 = z0 - dart.notNull(k1) + dart.notNull(vector_math_64.SimplexNoise._G3);
      let x2 = x0 - dart.notNull(i2) + 2.0 * dart.notNull(vector_math_64.SimplexNoise._G3);
      let y2 = y0 - dart.notNull(j2) + 2.0 * dart.notNull(vector_math_64.SimplexNoise._G3);
      let z2 = z0 - dart.notNull(k2) + 2.0 * dart.notNull(vector_math_64.SimplexNoise._G3);
      let x3 = x0 - 1.0 + 3.0 * dart.notNull(vector_math_64.SimplexNoise._G3);
      let y3 = y0 - 1.0 + 3.0 * dart.notNull(vector_math_64.SimplexNoise._G3);
      let z3 = z0 - 1.0 + 3.0 * dart.notNull(vector_math_64.SimplexNoise._G3);
      let ii = i & 255;
      let jj = j & 255;
      let kk = k & 255;
  ...
  vector_math_64.degrees = function degrees(radians) {
    return dart.notNull(radians) * dart.notNull(vector_math_64.radians2Degrees);
  };
  vector_math_64.radians = function radians(degrees) {
    return dart.notNull(degrees) * dart.notNull(vector_math_64.degrees2Radians);
  };
  ...
  vector_math_64.buildPlaneVectors = function buildPlaneVectors(planeNormal, u, v) {
    let t0, t0$, t0$0, t0$1;
    if (planeNormal.z[$abs]() > dart.notNull(math.sqrt1_2)) {
  ...
  dart.defineLazy(vector_math_64, {
    /*vector_math_64.degrees2Radians*/get degrees2Radians() {
      return dart.notNull(math.pi) / 180.0;
    },
    /*vector_math_64.radians2Degrees*/get radians2Degrees() {
      return 180.0 / dart.notNull(math.pi);
    }
  });
