define(['dart_sdk', 'packages/flutter_web_ui/ui', 'packages/flutter_web/io', 'packages/typed_data/typed_buffers'], function(dart_sdk, ui, io, typed_buffers) {
  ...
  src__foundation__binding._exitApplication = function _exitApplication() {
  ...
  src__foundation__print.debugPrintSynchronously = function debugPrintSynchronously(message, opts) {
  ...
  src__foundation__print.debugPrintThrottled = function debugPrintThrottled(message, opts) {
    let t1, t1$;
    let wrapWidth = opts && 'wrapWidth' in opts ? opts.wrapWidth : null;
  ...
  src__foundation__print._debugPrintTask = function _debugPrintTask() {
    let t1;
  ...
  src__foundation__print.debugWordWrap = function debugWordWrap(message, width, opts) {
  ...
  src__foundation__debug.debugAssertAllFoundationVarsUnset = function debugAssertAllFoundationVarsUnset(reason, opts) {
  ...
  src__foundation__debug.debugInstrumentAction = function debugInstrumentAction(T, description, action) {
    let t1;
  ...
  src__foundation__debug.debugFormatDouble = function debugFormatDouble(value) {
    if (value == null) {
      return "null";
    }
  ...
  src__foundation__diagnostics.DiagnosticsNode = class DiagnosticsNode extends core.Object {
    ...
    static message(message, opts) {
      ...
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1459, 12, "| !name.endsW");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1460, 12, "        'Name");
    ...
    toString(opts) {
      ...
      if (!(this.style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1607, 12, " data['allowN");
      if (!(minLevel != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1608, 12, "lowNameWrap;\n\n  ");
    ...
    get textTreeConfiguration() {
      if (!(this.style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1627, 12, "l = Diagnosti");
      switch (this.style) {
  ...
  (src__foundation__diagnostics.DiagnosticsNode.new = function(opts) {
    ...
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1433, 16, "r.build();\n  }\n}");
    if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1434, 16, "nostics data for a [v");
    if (!(name == null || !name[$endsWith](":"))) dart.assertFailed("Names of diagnostic nodes must not end with colons.\n" + "name:\n" + "  \"" + dart.str(name) + "\"", "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1439, 13, "embers exist\n/// typically to provi");
    ;
  ...
  src__foundation__diagnostics.DiagnosticsProperty$ = dart.generic(T => {
    class DiagnosticsProperty extends src__foundation__diagnostics.DiagnosticsNode {
      ...
      [_addTooltip](text) {
        if (!(text != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2586, 12, "iption({Text");
      ...
      [_maybeCacheValue]() {
        ...
        if (!(this[_computeValue] != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2655, 12, "alueCallback],\n  /// ");
        try {
    ...
    (DiagnosticsProperty.new = function(name, value, opts) {
      ...
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2437, 16, "erty causes it t");
      if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2438, 16, "higher\n  /// level. F");
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2439, 16, " property val");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2440, 16, "ssingIfNull] ");
    ...
    (DiagnosticsProperty.lazy = function(name, computeValue, opts) {
      ...
      this[allowWrap$] = allowWrap;
      this[allowNameWrap$] = allowNameWrap;
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2483, 16, " it to have a lo");
      if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2484, 16, "/ level. For example,");
      if (!(dart.equals(defaultValue, src__foundation__diagnostics.kNoDefaultValue) || T.is(defaultValue))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2485, 16, "teValue` throws an exception, [level]\n  /// will alw");
      if (!(missingIfNull != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2486, 16, "sticLevel.error].\n  D");
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2487, 16, ".lazy(\n    St");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2488, 16, "putePropertyV");
      this[_description] = description;
    ...
    class DiagnosticableMixin extends Object {
      ...
      toString(opts) {
        ...
        if (!dart.test(dart.fn(() => {
          ...
          return true;
        }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2935, 12, "//    class already describes the children of a node properly or a node has\n///    no children.\n///  * [DiagnosticsProperty], which should be used to");
        t2 = fullString;
  ...
  src__foundation__assertions.debugPrintStack = function debugPrintStack(opts) {
  ...
  (src__foundation__diagnostics.TextTreeConfiguration.new = function(opts) {
    ...
    if (!(prefixLineOne != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 215, 16, "prefixLineOne != null");
    if (!(prefixOtherLines != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 216, 16, "prefixOtherLines != null");
    if (!(prefixLastChildLineOne != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 217, 16, "prefixLastChildLineOne != null");
    if (!(prefixOtherLinesRootNode != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 218, 16, "prefixOtherLinesRootNode != null");
    if (!(linkCharacter != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 219, 16, "linkCharacter != null");
    if (!(propertyPrefixIfChildren != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 220, 16, "propertyPrefixIfChildren != null");
    if (!(propertyPrefixNoChildren != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 221, 16, "propertyPrefixNoChildren != null");
    if (!(lineBreak != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 222, 16, "lineBreak != null");
    if (!(lineBreakProperties != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 223, 16, "lineBreakProperties != null");
    if (!(afterName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 224, 16, "afterName != null");
    if (!(afterDescriptionIfBody != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 225, 16, "afterDescriptionIfBody != null");
    if (!(afterDescription != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 226, 16, "afterDescription != null");
    if (!(beforeProperties != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 227, 16, "beforeProperties != null");
    if (!(afterProperties != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 228, 16, "afterProperties != null");
    if (!(propertySeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 229, 16, "propertySeparator != null");
    if (!(bodyIndent != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 230, 16, "bodyIndent != null");
    if (!(footer != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 231, 16, "footer != null");
    if (!(showChildren != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 232, 16, "showChildren != null");
    if (!(addBlankLineIfNoChildren != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 233, 16, "addBlankLineIfNoChildren != null");
    if (!(isNameOnOwnLine != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 234, 16, "isNameOnOwnLine != null");
    if (!(isBlankLineBetweenPropertiesAndChildren != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 235, 16, "isBlankLineBetweenPropertiesAndChildren != null");
  ...
  src__foundation__diagnostics._PrefixedStringBuilder = class _PrefixedStringBuilder extends core.Object {
            ...
            case src__foundation__diagnostics._WordWrapParseMode.atBreak:
            {
              if (index - startForLengthCalculations > dart.notNull(width) || index === message.length) {
                ...
                if (lastWordEnd === index) {
                  ...
                  if (!(dart.notNull(lastWordStart) > dart.notNull(lastWordEnd))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 943, 22, ";\n            yield line;\n ");
                  start = lastWordStart;
                  mode = src__foundation__diagnostics._WordWrapParseMode.atBreak;
                }
                startForLengthCalculations = dart.notNull(start) - dart.notNull(otherLineOffset);
                if (!addPrefix) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 948, 20, "current p");
                lastWordEnd = null;
              } else {
                lastWordEnd = index;
    ...
    writeRawLines(lines) {
      ...
      if (!dart.test(this[_currentLine].isEmpty)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1025, 12, "\n    String line, {\n");
    ...
    writeStretched(text, targetLineLength) {
      ...
      if (!(dart.notNull(this[_currentLine].length) > 0)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1038, 12, "es);\n  }\n\n  /// Write l");
      let targetLength = dart.notNull(targetLineLength) - currentLineLength;
      if (targetLength > 0) {
        if (!text[$isNotEmpty]) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1041, 14, "t.\n  void write");
        let lastChar = text[$_get](text.length - 1);
        if (!(lastChar !== "\n")) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1043, 14, "rentLine.isNotEm");
    ...
    render(node, opts) {
      ...
      if (dart.test(children[$isNotEmpty]) && dart.test(config.showChildren)) {
        ...
        for (let i = 0; i < dart.notNull(children[$length]); i = i + 1) {
          ...
          if (!(child != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1353, 16, "\n    if (chil");
  ...
  (src__foundation__diagnostics.TextTreeRenderer.new = function(opts) {
    ...
    if (!(minLevel != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1091, 16, "th] and the curr");
  ...
  (src__foundation__diagnostics.MessageProperty.new = function(name, message, opts) {
    let style = opts && 'style' in opts ? opts.style : src__foundation__diagnostics.DiagnosticsTreeStyle.singleLine;
    let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
    if (!(name != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1734, 16, "nosticsNode.");
    if (!(message != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1735, 16, "rves the same r");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1736, 16, "//    without");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1737, 16, "name.\n///  * ");
  ...
  (src__foundation__diagnostics.StringProperty.new = function(name, value, opts) {
    ...
    let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
    this[quoted$] = quoted;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1762, 16, "//\n/// See also:");
    if (!(quoted != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1763, 16, "geProperty], w");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1764, 16, "it for showin");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1765, 16, " instead of d");
  ...
  (src__foundation__diagnostics.DoubleProperty.new = function(name, value, opts) {
    ...
    let style = opts && 'style' in opts ? opts.style : src__foundation__diagnostics.DiagnosticsTreeStyle.singleLine;
    let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1897, 16, "mberToString();\n");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1898, 16, "y describing ");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1899, 16, " with an opti");
  ...
  (src__foundation__diagnostics.DoubleProperty.lazy = function(name, computeValue, opts) {
    ...
    let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : src__foundation__diagnostics.kNoDefaultValue;
    let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1927, 16, "       unit: uni");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1928, 16, "ip: tooltip,\n");
  ...
  (src__foundation__diagnostics.IntProperty.new = function(name, value, opts) {
    ...
    let style = opts && 'style' in opts ? opts.style : src__foundation__diagnostics.DiagnosticsTreeStyle.singleLine;
    let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1960, 16, "\n          level");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1961, 16, ";\n\n  @overrid");
    if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1962, 16, "oString() => ");
  ...
  (src__foundation__diagnostics.PercentProperty.new = function(name, fraction, opts) {
    ...
    let unit = opts && 'unit' in opts ? opts.unit : null;
    let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1996, 16, " [double] to bet");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 1997, 16, "ormats it as ");
  ...
  (src__foundation__diagnostics.FlagProperty.new = function(name, opts) {
    ...
    if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2075, 16, " also:\n///\n///  ");
    if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2076, 16, "rty], which p");
    if (!(ifTrue != null || ifFalse != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2077, 16, "havior describing whether\n///    ");
  ...
  src__foundation__diagnostics.IterableProperty$ = dart.generic(T => {
    ...
    (IterableProperty.new = function(name, value, opts) {
      ...
      let showSeparator = opts && 'showSeparator' in opts ? opts.showSeparator : true;
      let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
      if (!(style != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2169, 16, "// elements i");
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2170, 16, "fEmpty] equals n");
      if (!(showSeparator != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2171, 16, " that an\n  /// empty ");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2172, 16, "s not interes");
  ...
  src__foundation__diagnostics.EnumProperty$ = dart.generic(T => {
    ...
    (EnumProperty.new = function(name, value, opts) {
      let defaultValue = opts && 'defaultValue' in opts ? opts.defaultValue : src__foundation__diagnostics.kNoDefaultValue;
      let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2269, 16, ")).toList();\n");
  ...
  src__foundation__diagnostics.ObjectFlagProperty$ = dart.generic(T => {
    ...
    (ObjectFlagProperty.new = function(name, value, opts) {
      ...
      if (!(ifPresent != null || ifNull != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2316, 16, "vides similar functionality describ");
      if (!(showName != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2317, 16, " a [value] is tr");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2318, 16, " ObjectFlagPr");
    ...
    (ObjectFlagProperty.has = function(name, value, opts) {
      let level = opts && 'level' in opts ? opts.level : src__foundation__diagnostics.DiagnosticLevel.info;
      if (!(name != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2337, 16, "bool showNam");
      if (!(level != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2338, 16, "gnosticLevel ");
  ...
  src__foundation__diagnostics.DiagnosticableNode$ = dart.generic(T => {
    ...
    (DiagnosticableNode.new = function(opts) {
      ...
      this[value$] = value;
      if (!(value != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2739, 16, "f (object is ");
  ...
  src__foundation__diagnostics._isSingleLine = function _isSingleLine(style) {
    return dart.equals(style, src__foundation__diagnostics.DiagnosticsTreeStyle.singleLine);
  };
  src__foundation__diagnostics.shortHash = function shortHash(object) {
    return dart.hashCode(object)[$toUnsigned](20)[$toRadixString](16)[$padLeft](5, "0");
  };
  src__foundation__diagnostics.describeIdentity = function describeIdentity(object) {
    return dart.str(dart.runtimeType(object)) + "#" + dart.str(src__foundation__diagnostics.shortHash(object));
  };
  src__foundation__diagnostics.describeEnum = function describeEnum(enumEntry) {
    let description = dart.toString(enumEntry);
    let indexOfDot = description[$indexOf](".");
    if (!(indexOfDot !== -1 && indexOfDot < description.length - 1)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/foundation/diagnostics.dart", 2838, 10, "e}#${shortHash(object)}';\n\n// This method exists as a w");
    return description[$substring](indexOfDot + 1);
  };
  src__foundation__diagnostics.debugPrintDouble = function debugPrintDouble(value) {
  ...
  src__foundation__profile.profile = function profile(func) {
  ...
  src__foundation__collections.setEquals = function setEquals(T, a, b) {
  ...
  src__foundation__collections.listEquals = function listEquals(T, a, b) {
    if (a == null) return b == null;
    if (b == null || a[$length] != b[$length]) return false;
  ...
  src__foundation__isolates.compute = function compute(Q, R, callback, message, opts) {
